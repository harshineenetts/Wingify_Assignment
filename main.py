...
def run_crew(query: str, file_path: str):
    ...
    # CRITICAL FIX: Pass the file_path into the inputs dictionary so the tasks 
    # and tools can dynamically access {file_path} via string interpolation.
...
if __name__ == "__main__":
    import uvicorn
    # Changed from app to 'main:app' as string is standard for uvicorn to avoid multiprocessing quirks
